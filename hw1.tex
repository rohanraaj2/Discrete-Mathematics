...
\author{Isomorphic}  % replace with your team name
...
\question[5]
  ...
  Set X contains 4 elements.
  $|$P(X)$|$ = 2\^(4)\ = 16

  $ P(X) = \{ \emptyset, \{ \{\alpha, \beta, \gamma \} \}, \{ \gamma \}, \{ \{\{ \alpha, \beta \} \} \}, \{ \emptyset, \{\alpha, \beta, \gamma \} \}, \{\emptyset, \gamma \}, \{ \emptyset, \{ \{ \alpha, \beta \} \} \} \}, \{ \{ \alpha, \beta, \gamma \}, \gamma \}, \{ \{ \alpha, \beta, \gamma \}, \{ \{ \alpha, \beta \} \} \}, \newline \{ \gamma, \{ \{ \alpha, \beta \} \} \}, \{ \emptyset, \{ \alpha, \beta, \gamma \}, \gamma \}, \{ \emptyset, \{ \alpha, \beta, \gamma \}, \{ \{ \alpha, \beta \} \} \}, \{ \{ \alpha, \beta, \gamma \}, \gamma, \{ \{ \alpha, \beta \} \} \}, \{ \emptyset \}, \{ \emptyset, \{ \{ \alpha, \beta \} \}, \gamma \}, \{ \emptyset, \{ \alpha, \beta, \gamma \}, \newline \gamma, \{ \{ \alpha, \beta \} \} \} \}$
\question
  \begin{parts}
  \part[5] 
